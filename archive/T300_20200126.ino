...
#include <Servo.h>
#include <Wire.h>
#include <hd44780.h> // LiquidCrystal has no background light on/off
...
int wall = 3;               // need 3 wall readings to stop/turn
