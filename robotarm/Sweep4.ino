...
void loop() {
  for (pos1 = 90; pos1 <= MAX1; pos1 += 1) { // goes from 0 degrees to 180 degrees
    serv1.write(pos1);
    delay(15);
  }
  for (pos1 = MAX1; pos1 >= MIN1; pos1 -= 1) { 
    serv1.write(pos1);
    delay(15);
  }
  ...
  for (pos2 = MIN2; pos2 <= MAX2; pos2 += 1) { // up and down
    serv2.write(pos2);
    delay(15);
  }
  for (pos2 = MAX2; pos2 >= MIN2; pos2 -= 1) { 
    serv2.write(pos2);
    delay(15);
  }
  for (pos3 = MIN3; pos3 <= MAX3; pos3 += 1) { // forward and back
    serv3.write(pos3);
    delay(15);
  }
  for (pos3 = MAX3; pos3 >= MIN3; pos3 -= 1) { 
    serv3.write(pos3);
    delay(15);
  }
  for (pos4 = MIN4; pos4 <= MAX4; pos4 += 1) { // open and close
    serv4.write(pos4);
    delay(15);
  }
  for (pos4 = MAX4; pos4 >= MIN4; pos4 -= 1) { 
    serv4.write(pos4);
    delay(15);
  }
  delay(1000);
